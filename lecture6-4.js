...
const numObj3 = new Number(-123.45); // Number {-123.45}
...
// Not a Number = 모두 Number {NaN}으로 출력
console.log(
  new Number("1/2"),
  new Number("123ABC"),
  new Number("ABC"),
...
console.log(
  isFinite(null), // true -> null을 0으로 반환
  Number.isFinite(null) // false
);

console.log(
  isNaN("abc"), // true -> 숫자타입의 NaN으로 변환
...
// 4. 인스턴스 메서드
// ⭐️ 값 자체에서 호출시 괄호로 감쌀 것 (소수점과 구분 불가)
